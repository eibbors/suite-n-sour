...
(function() {
  ...
  exports.complexTypes = {
    ...
    WriteResponseList: {
      elements: {
        writeResponse: {
          type: 'platformMsgs:WriteResponse',
          maxOccurs: 'unbounded'
        }
      }
    },
    ReadResponseList: {
      elements: {
        readResponse: {
          type: 'platformMsgs:ReadResponse',
          minOccurs: '0',
          maxOccurs: 'unbounded'
        }
      }
    ...
    LoginResponse: {
      elements: {
        sessionResponse: {
          type: 'platformMsgs:SessionResponse'
        }
      }
    },
    SsoLoginResponse: {
    ...
    AddListResponse: {
      elements: {
        writeResponseList: {
          type: 'platformMsgs:WriteResponseList'
        }
      }
    },
    UpdateResponse: {
    ...
    GetListResponse: {
      elements: {
        readResponseList: {
          type: 'platformMsgs:ReadResponseList'
        }
      }
    },
    GetAllResponse: {
    ...
    MapSsoRequest: {
      elements: {
        ssoCredentials: {
          type: 'platformCore:SsoCredentials'
        }
      }
    },
    ChangePasswordRequest: {
      elements: {
        changePassword: {
          type: 'platformCore:ChangePassword'
        }
      }
    },
    ChangeEmailRequest: {
    ...
    SearchRequest: {
      elements: {
        searchRecord: {
          type: 'platformCore:SearchRecord'
        }
      }
    },
    SearchMoreRequest: {
    ...
    GetAllRequest: {
      elements: {
        record: {
          type: 'platformCore:GetAllRecord',
          minOccurs: '1'
        }
      }
    },
    GetSavedSearchRequest: {
      elements: {
        record: {
          type: 'platformCore:GetSavedSearchRecord',
          minOccurs: '1'
        }
      }
    },
    GetCustomizationIdRequest: {
      elements: {
        customizationType: {
          type: 'platformCore:CustomizationType',
          minOccurs: '1'
        },
        includeInactives: {
          type: 'xsd:boolean',
    ...
    InitializeRequest: {
      elements: {
        initializeRecord: {
          type: 'platformCore:InitializeRecord',
          minOccurs: '1'
        }
      }
    },
    ...
    getSelectValueRequest: {
      elements: {
        fieldDescription: {
          type: 'platformCore:GetSelectValueFieldDescription',
          minOccurs: '1',
          maxOccurs: '1'
        },
        pageIndex: {
    ...
    GetItemAvailabilityRequest: {
      elements: {
        itemAvailabilityFilter: {
          type: 'platformCore:ItemAvailabilityFilter',
          minOccurs: '1',
          maxOccurs: '1'
        }
      }
    ...
    GetBudgetExchangeRateRequest: {
      elements: {
        budgetExchangeRateFilter: {
          type: 'platformCore:BudgetExchangeRateFilter',
          minOccurs: '1',
          maxOccurs: '1'
        }
      }
    ...
    GetConsolidatedExchangeRateRequest: {
      elements: {
        consolidatedExchangeRateFilter: {
          type: 'platformCore:ConsolidatedExchangeRateFilter',
          minOccurs: '1',
          maxOccurs: '1'
        }
      }
    ...
    GetCurrencyRateRequest: {
      elements: {
        currencyRateFilter: {
          type: 'platformCore:CurrencyRateFilter',
          minOccurs: '1',
          maxOccurs: '1'
        }
      }
    ...
    GetPostingTransactionSummaryRequest: {
      elements: {
        fields: {
          type: 'platformCore:PostingTransactionSummaryField',
          minOccurs: '1',
          maxOccurs: '1'
        },
        filters: {
          type: 'platformCore:PostingTransactionSummaryFilter',
          minOccurs: '0',
          maxOccurs: '1'
        },
        pageIndex: {
    ...
    AttachRequest: {
      elements: {
        attachReference: {
          type: 'platformCore:AttachReference',
          minOccurs: '1',
          maxOccurs: '1'
        }
      }
    ...
    DetachRequest: {
      elements: {
        detachReference: {
          type: 'platformCore:DetachReference',
          minOccurs: '1',
          maxOccurs: '1'
        }
      }
    ...
    UpdateInviteeStatusRequest: {
      elements: {
        updateInviteeStatusReference: {
          type: 'platformCore:UpdateInviteeStatusReference',
          minOccurs: '1'
        }
      }
    },
    ...
    GetDeletedRequest: {
      elements: {
        getDeletedFilter: {
          type: 'platformCore:GetDeletedFilter',
          minOccurs: '1',
          maxOccurs: '1'
        }
      }
