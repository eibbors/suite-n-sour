...
<<<<<<< HEAD
      var dr, _ref, _ref1, _ref2, _ref3, _ref4, _ref5,
=======
...
<<<<<<< HEAD
          elements.url = (_ref1 = this["debugger"].source.url) != null ? _ref1 : 'debugger$debugger.user';
        }
        if ((_ref2 = elements.sourceid) == null) {
          elements.sourceid = (_ref3 = this["debugger"].source.sourceid) != null ? _ref3 : -1;
        }
        if (options.cf !== false) {
          if ((_ref4 = elements.frame) == null) {
            elements.frame = (_ref5 = this["debugger"].frame) != null ? _ref5 : 0;
=======
...
<<<<<<< HEAD
        ...
        if (res.headers['content-type'] === 'text/javascript; charset=UTF-8') {
          ...
          _this["debugger"] = (_ref6 = new NsDebugger(res.parsed.debuggerState)) != null ? _ref6 : null;
=======
        var _ref8;
        if (res.headers['content-type'] === 'text/javascript; charset=UTF-8') {
          eval("res.parsed = (" + res.body + ")");
