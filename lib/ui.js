(function() {
  ...
  NsUiClient = (function() {
    ...
    NsUiClient.prototype._nlapiRecReq = function(attr, el, cb) {
      var _this = this;
    ...
    NsUiClient.prototype.createRecord = function(recordType, initDefaults, cb) {
      var attr, el;
      attr = {
      ...
      if (initDefaults) {
        el = {
          loadParams: initDefaults
        };
      } else {
        el = {};
      }
      return this._nlapiRecReq(attr, el, cb);
    };

    NsUiClient.prototype.loadRecord = function(recordType, id, initDefaults, cb) {
      var attr, el;
      attr = {
    ...
    NsUiClient.prototype.copyRecord = function(recordType, id, initDefaults, cb) {
      var attr, el;
      attr = {
    ...
    NsUiClient.prototype.sendFax = function(author, recipient, subject, body, cc, bcc, records, cb) {
      var attr, el, k, _i, _len, _ref;
      if (cc == null) cc = null;
      ...
      _ref = ['transaction', 'entity', 'recordType', 'record', 'activity'];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        k = _ref[_i];
        if (records[k] != null) el[k] = records[k];
      }
      return this.nlapir(attr, el, {}, cb);
    };
        ...
        switch (key) {
          ...
          case 'machine':
            for (_i = 0, _len = value.length; _i < _len; _i++) {
              ...
              this.lineItems[matts.name] = (_ref7 = mach['line']) != null ? _ref7 : [];
