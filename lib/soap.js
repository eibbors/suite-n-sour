...
(function() {
  var ComplexType, EnumType, QName, dump, p, resolveSchema, rpc, rr, util, wsdl, x, xml, xmlns, xsd,
  ...
  ComplexType = (function(_super) {
    ...
    function ComplexType(name, type, options) {
      ...
      this.qname = xmlns.resolveNamespace(type);
    ...
    ComplexType.prototype.defElem = function(name, value) {
      switch (value.type) {
        case 'xsd:string':
