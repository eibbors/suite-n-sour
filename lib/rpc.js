...
(function() {
  var EventEmitter, JSONR_HANDLER, NsRpcClient, NsRpcResponse, SUCCESSFUL_STATUS_CODES, XMLR_HANDLER, http, https, qs, url, xml, zlib,
  ...
  NsRpcClient = (function(_super) {
    ...
    NsRpcClient.prototype.urlr = function(target, options, cb) {
      var cref, path, u, ur, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
      if (options == null) {
        options = {};
      }
      u = url.parse(target);
      ...
      path = (_ref = (_ref1 = (_ref2 = options.path) != null ? _ref2 : u.pathname) != null ? _ref1 : u.path) != null ? _ref : void 0;
      if ((_ref3 = options.host) == null) {
        options.host = (_ref4 = u.host) != null ? _ref4 : this.host;
      }
      if ((_ref5 = options.port) == null) {
        options.port = (_ref6 = u.port) != null ? _ref6 : this.port;
      }
      if ((_ref7 = options.query) == null) {
        options.query = (_ref8 = u.query) != null ? _ref8 : void 0;
      }
