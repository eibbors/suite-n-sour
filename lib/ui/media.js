...
(function() {
  ...
  MediaFile = (function() {
    ...
    function MediaFile(options) {
      ...
      this.parentFolder = (_ref3 = options.parentFolder) != null ? _ref3 : null;
      this.encoding = (_ref4 = (_ref5 = (_ref6 = options.encoding) != null ? _ref6.id : void 0) != null ? _ref5 : options.encoding) != null ? _ref4 : NS_TEXTFILE_ENCODING.UTF8.id;
      this.url = (_ref7 = options.url) != null ? _ref7 : null;
      this.filename = (_ref8 = options.filename) != null ? _ref8 : "mf" + ((new Date).getTime().toString(16));
      this.type = (_ref9 = options.type) != null ? _ref9 : 'text/plain';
      this.value = (_ref10 = options.value) != null ? _ref10 : null;
    }
    ...
    MediaFile.prototype.getMPFormParams = function(obj) {
      ...
      for (k in this) {
        v = this[k];
        if (k === 'id' || k === 'filetype' || k === 'folder' || k === 'parentFolder' || k === 'encoding' || k === 'url') {
