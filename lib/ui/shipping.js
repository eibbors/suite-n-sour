...
(function() {
  ...
  exports.extend = function(client) {
    var handleShippingResponse;
    handleShippingResponse = function(res, cb) {
      var _this = this;
      if (res.result) {
        return xml.parse(res.result, function(err, data) {
          ...
          return cb(data != null ? data : null, res);
        });
      } else {
        return cb(null, res);
      }
    ...
    client.prototype.getShippingRates = function(ratesReq, cb) {
      ...
      return this.jsonr('getShippingRates', [payload], opts, function(res) {
        return handleShippingResponse(res, cb);
      });
    };
    ...
    client.prototype.getTaxItem = function(entityId, state, zip, country, cb) {
      ...
      return this.jsonr('getTaxItem', [payload], opts, function(res) {
        return handleShippingResponse(res, cb);
      });
    };
    return {
